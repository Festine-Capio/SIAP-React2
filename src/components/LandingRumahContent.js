      ...
      <div className="row">
        <div className="col">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">SIAP dana Rumah</Typography>
          </Breadcrumbs>
        </div>
      </div>
        ...
        <div className="col">
          <div className="row">
            ...
            <div className="col ml-4">
              <Card className="list-home">
                <div className="row mt-3 mb-2">
                  <div className="col-sm-1"></div>
                  <div className="col">
                    <h6> Tentang dana rumah</h6>
                  </div>
                </div>
              </Card>
            </div>
          ...
          <div className="row ml-1 mt-5">
            <div className="col-md-9">
              <Button variant="primary" active block>
...
export default LandingRumahContent;